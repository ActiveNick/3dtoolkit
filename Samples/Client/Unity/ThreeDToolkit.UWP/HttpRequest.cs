...
namespace ThreeDToolkit
{
    public class HttpRequest
    {
        ...
        private async Task<HttpWebRequest> InternalBuildRequestAsync()
        {
        ...
        public HttpWebResponse Sync()
        {
            var req = this.InternalBuildRequestAsync().Result;
            return req.GetResponseAsync().Result as HttpWebResponse;
        }

        public async Task<IAsyncResult> DoneAsync(Action<HttpWebResponse> onSuccess, Action<Exception> onError = null)
        {
            try
            {
                var req = await this.InternalBuildRequestAsync();
